...
#include <memory>
#include "../../DBtraining/droptable.h"
...
QT_MOC_LITERAL(4, 42, 23) // "on_pushButton_2_clicked"
    ...
    "DropTable\0sendData\0\0on_pushButton_clicked\0"
...
void DropTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DropTable::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DropTable::sendData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DropTable::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DropTable.data,
...
// SIGNAL 0
void DropTable::sendData(QString _t1)
{
