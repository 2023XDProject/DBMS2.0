...
public:
    ...
    void setupUi(QWidget *updateTable)
    {
        ...
        label_2->setGeometry(QRect(90, 150, 121, 41));
        QFont font1;
...
""));
        ...
        set_textEdit->setGeometry(QRect(260, 150, 351, 51));
        set_textEdit->setFont(font2);
...
""));
        ...
        where_textEdit->setGeometry(QRect(260, 240, 351, 51));
        where_textEdit->setFont(font2);
...
""));
        ...
        update_pushButton->setGeometry(QRect(120, 340, 121, 71));
...
""));
        ...
        back_pushButton->setGeometry(QRect(440, 340, 121, 71));
...
""));
    ...
    void retranslateUi(QWidget *updateTable)
    {
        ...
        label->setText(QCoreApplication::translate("updateTable", "\350\241\250\345\220\215", nullptr));
        label_2->setText(QCoreApplication::translate("updateTable", "set", nullptr));
        label_3->setText(QCoreApplication::translate("updateTable", "\346\235\241\344\273\266", nullptr));
